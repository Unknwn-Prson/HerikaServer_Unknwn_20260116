    ...
    <div class="form-grid">
        ...
        <div class="form-item span-2">
            ...
            $overrideEditorConfig = [
                ...
                'allowedSettings' => ['TTSFUNCTION','RECHAT_H','RECHAT_P','RECHAT_ALLOW_ACTIONS','CORE_LANG','ENFORCE_ACTIONS_PROMPT','REMOVE_ASTERISKS_FROM_OUTPUT','MAX_WORDS_LIMIT','DIARY_PROMPT','DIARY_COOLDOWN','COMBAT_BARK_COOLDOWN','AUTO_DIARY_WAIT','INJECT_DIARIES','DIARY_THRESHOLD_MODIFIER','DIARY_MIN_AGE_HOURS','DIARY_GENERATION_MODE','DIARY_EVENTS_THRESHOLD','OGHMA_INFINIUM','OGHMA_AMOUNT','MINIME_T5','CONTEXT_HISTORY','CONTEXT_HISTORY_DIARY','CONTEXT_HISTORY_DYNAMIC_PROFILE','QUEST_COMMENT','QUEST_COMMENT_CHANCE','BORED_EVENT','BORED_EVENT_SERVERSIDE','HERIKA_ANIMATIONS','LANG_LLM_XTTS'],
