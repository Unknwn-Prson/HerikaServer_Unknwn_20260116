@echo off
:: ============================================================
:: CHIM Proxy v0.9.12 - One-Time Setup
...
if %errorlevel% equ 0 (
    ...
    echo        or run: netsh advfirewall firewall add rule name="CHIM Proxy" dir=in action=allow protocol=TCP localport=38700
)
:firewall_done
echo.
